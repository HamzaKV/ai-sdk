...
- **Streaming**  
  [`handleStreamResponse`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts): Parse streaming AI responses (SSE, JSON lines, etc.).  
  [`createDataStream`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts): Create a readable stream for streaming data.  
  [`pipeStreamToResponse`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts): Pipe a stream to Node.js or Web Response objects.

- **Structure & Tooling**  
  [`defineStructure`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/structure.ts): Type-safe schema definition.  
  [`defineTool`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/tool.ts): Standardize tool/external function definitions.
...
- [`defineProvider`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/provider.ts) – Create a provider with models and context.
- [`createAIClient`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/index.ts) – Compose providers and middleware into a unified client.
- [`cosineSimilarity`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/cosine.ts) – Vector similarity.
- [`handleStreamResponse`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts) – Streaming response parser.
- [`createDataStream`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts) – Streaming data generator.
- [`pipeStreamToResponse`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/streaming.ts) – Pipe streams to responses.
- [`defineStructure`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/structure.ts) – Schema definition.
- [`defineTool`](https://github.com/HamzaKV/ai-sdk/blob/main/packages/ai/src/utils/tool.ts) – Tool definition.
